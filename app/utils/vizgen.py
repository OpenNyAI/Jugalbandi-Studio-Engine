...
class VizGenerator():
    ...
    def build_tree(self) -> str:
        ...
        relation_map_tuple = sorted(relation_map.items(), key = lambda t: task_name_mapping[t[0][1]])
        ...
        # edge styling
        for link_lst, link_stl in [(s_link, s_link_style), (e_link, e_link_style), (d_link, d_link_style)]:
            if len(link_lst) > 0:
